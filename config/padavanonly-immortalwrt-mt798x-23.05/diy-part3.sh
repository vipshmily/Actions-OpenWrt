...
UPDATE_PACKAGE() {
	...
	rm -rf $(find ../feeds/luci/ ../feeds/packages/ ../packages/ -maxdepth 3 -type d -iname "*$PKG_NAME*" -prune)
...
UPDATE_PACKAGE "store" "kiddin9/openwrt-packages" "master" "pkg"
UPDATE_PACKAGE "istorex" "kiddin9/openwrt-packages" "master" "pkg"
UPDATE_PACKAGE "xterm" "kiddin9/openwrt-packages" "master" "pkg"
...
#UPDATE_PACKAGE "golang" "kenzok8/golang" "main"
...
UPDATE_VERSION() {
	...
	local PKG_FILES=$(find ./ ../feeds/packages/ ../packages/ -maxdepth 3 -type f -wholename "*/$PKG_NAME/Makefile")
