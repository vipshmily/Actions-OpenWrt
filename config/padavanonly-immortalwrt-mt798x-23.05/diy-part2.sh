...
git clone https://github.com/kenzok8/openwrt-packages.git package/luci-app-quickstart
git clone https://github.com/kenzok8/openwrt-packages.git package/luci-app-store
