...
cp -f $GITHUB_WORKSPACE/config/padavanonly-immortalwrt/mt7621_xiaomi_mi-router-4a-3g-v2.dtsi $GITHUB_WORKSPACE/openwrt/target/linux/ramips/dts/mt7621_xiaomi_mi-router-4a-3g-v2.dtsi
#cp -f $GITHUB_WORKSPACE/config/ipadavanonly-immortalwrt//mt7628an_xiaomi_mi-router-4c.dts $GITHUB_WORKSPACE/openwrt/target/linux/ramips/dts/mt7628an_xiaomi_mi-router-4c.dts
