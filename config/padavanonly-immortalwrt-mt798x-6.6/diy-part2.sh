...
# 替换编译目录文件
#cp -f $GITHUB_WORKSPACE/config/padavanonly-immortalwrt-mt798x-6.6/mt7981b-nokia-ea0326gmp.dts $GITHUB_WORKSPACE/openwrt/target/linux/mediatek/dts/mt7981b-nokia-ea0326gmp.dts
