...
'''
    获取可转债基础数据
'''
# kzz_info = tq.get_kzz_info(stock_code = '123049.SZ', field_list=[])
# print(kzz_info)
...
'''
# zxg_result = tq.send_user_block(block_code='ZXG', stocks=["600000.SH","600004.SH","000001.SZ","000002.SZ"], show=True)
# zxg_result = tq.send_user_block(block_code='CSBK', stocks=["600000.SH","600004.SH","000001.SZ","000002.SZ"], show=True)
...
'''
    在客户端调用功能或URL
'''
# exec_res = tq.exec_to_tdx(url='http://www.treeid/download_atonce')
# print(exec_res)
